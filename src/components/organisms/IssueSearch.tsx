...
import fetchGithubIssues from "../../api/fetchGithubIssue";
...
const IssueSearch = () => {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () =>
      fetchGithubIssues(queryParam, perPageParam, pageParam, owner, repo),
  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <ResultList results={results} isIssue={true} />
      )}
